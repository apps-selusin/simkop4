...
class ct03_pinjaman_edit extends ct03_pinjaman {
	...
	function Page_Main() {
		...
		switch ($this->CurrentAction) {
			case "I": // Get a record to display
				...
				break;
			Case "U": // Update
				$sReturnUrl = "t03_pinjamanedit.php?showdetail=t04_pinjamanangsuran,t05_pinjamanjaminan,t06_pinjamantitipan&id=".urlencode($this->id->CurrentValue);
	...
	function ValidateForm() {
		...
		if (in_array("t04_pinjamanangsuran", $DetailTblVar) && $GLOBALS["t04_pinjamanangsuran"]->DetailEdit) {
			...
			if ($bUpdateRow) {
				...
				if ($EditRow) {
					if (in_array("t04_pinjamanangsuran", $DetailTblVar) && $GLOBALS["t04_pinjamanangsuran"]->DetailEdit) {
						...
						$EditRow = $GLOBALS["t04_pinjamanangsuran_grid"]->GridUpdate();
	...
	function SetUpDetailParms() {
		...
		if ($sDetailTblVar <> "") {
			...
			if (in_array("t04_pinjamanangsuran", $DetailTblVar)) {
				...
				if ($GLOBALS["t04_pinjamanangsuran_grid"]->DetailEdit) {
					$GLOBALS["t04_pinjamanangsuran_grid"]->CurrentMode = "edit";
					$GLOBALS["t04_pinjamanangsuran_grid"]->CurrentAction = "gridedit";
...
ft03_pinjamanedit.Lists["x_nasabah_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t01_nasabah"};
...
<?php
	if (in_array("t04_pinjamanangsuran", explode(",", $t03_pinjaman->getCurrentDetailTable())) && $t04_pinjamanangsuran->DetailEdit) {
		if ($FirstActiveDetailTable == "" || $FirstActiveDetailTable == "t04_pinjamanangsuran") {
			$FirstActiveDetailTable = "t04_pinjamanangsuran";
		}
?>
		<li<?php echo $t03_pinjaman_edit->DetailPages->TabStyle("t04_pinjamanangsuran") ?>><a href="#tab_t04_pinjamanangsuran" data-toggle="tab"><?php echo $Language->TablePhrase("t04_pinjamanangsuran", "TblCaption") ?></a></li>
<?php
	}
?>
<?php
...
?>
		<div class="tab-pane<?php echo $t03_pinjaman_edit->DetailPages->PageStyle("t04_pinjamanangsuran") ?>" id="tab_t04_pinjamanangsuran">
