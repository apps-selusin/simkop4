...
$RootMenu->AddMenuItem(9, "mi_t96_employees", $Language->MenuPhrase("9", "MenuText"), "t96_employeeslist.php", 14, "", AllowListMenu('{1F4EE816-E057-4A7E-9024-5EA4446B7598}t96_employees'), FALSE, FALSE);
...
$RootMenu->AddMenuItem(26, "mci_About", $Language->MenuPhrase("26", "MenuText"), "", -1, "", TRUE, FALSE, TRUE);
$RootMenu->AddMenuItem(7, "mi_t94_log", $Language->MenuPhrase("7", "MenuText"), "t94_loglist.php", 26, "", AllowListMenu('{1F4EE816-E057-4A7E-9024-5EA4446B7598}t94_log'), FALSE, FALSE);
$RootMenu->AddMenuItem(13, "mi_t99_audittrail", $Language->MenuPhrase("13", "MenuText"), "t99_audittraillist.php", 26, "", AllowListMenu('{1F4EE816-E057-4A7E-9024-5EA4446B7598}t99_audittrail'), FALSE, FALSE);
