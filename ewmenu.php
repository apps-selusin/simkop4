...
$RootMenu->AddMenuItem(4, "mi_t04_pinjamanangsuran", $Language->MenuPhrase("4", "MenuText"), "t04_pinjamanangsuranlist.php", -1, "", AllowListMenu('{1F4EE816-E057-4A7E-9024-5EA4446B7598}t04_pinjamanangsuran'), FALSE, FALSE);
$RootMenu->AddMenuItem(5, "mi_t05_pinjamanjaminan", $Language->MenuPhrase("5", "MenuText"), "t05_pinjamanjaminanlist.php", -1, "", AllowListMenu('{1F4EE816-E057-4A7E-9024-5EA4446B7598}t05_pinjamanjaminan'), FALSE, FALSE);
$RootMenu->AddMenuItem(6, "mi_t06_pinjamantitipan", $Language->MenuPhrase("6", "MenuText"), "t06_pinjamantitipanlist.php", -1, "", AllowListMenu('{1F4EE816-E057-4A7E-9024-5EA4446B7598}t06_pinjamantitipan'), FALSE, FALSE);
