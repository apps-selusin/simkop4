...
ft04_pinjamanangsurangrid.EmptyRow = function(infix) {
	...
	if (ew_ValueChanged(fobj, infix, "Flag_Edit", false)) return false;
...
<?php if ($t04_pinjamanangsuran->Keterangan->Visible) { // Keterangan ?>
	<?php if ($t04_pinjamanangsuran->SortUrl($t04_pinjamanangsuran->Keterangan) == "") { ?>
		<th data-name="Keterangan"><div id="elh_t04_pinjamanangsuran_Keterangan" class="t04_pinjamanangsuran_Keterangan"><div class="ewTableHeaderCaption"><?php echo $t04_pinjamanangsuran->Keterangan->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="Keterangan"><div><div id="elh_t04_pinjamanangsuran_Keterangan" class="t04_pinjamanangsuran_Keterangan">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $t04_pinjamanangsuran->Keterangan->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($t04_pinjamanangsuran->Keterangan->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($t04_pinjamanangsuran->Keterangan->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($t04_pinjamanangsuran->Flag_Edit->Visible) { // Flag_Edit ?>
	...
	<?php } else { ?>
		<th data-name="Flag_Edit"><div><div id="elh_t04_pinjamanangsuran_Flag_Edit" class="t04_pinjamanangsuran_Flag_Edit">
...
<p class="form-control-static"><?php echo $t04_pinjamanangsuran->Angsuran_Ke->EditValue ?></p></span>
</span>
<input type="hidden" data-table="t04_pinjamanangsuran" data-field="x_Angsuran_Ke" name="x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Angsuran_Ke" id="x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Angsuran_Ke" value="<?php echo ew_HtmlEncode($t04_pinjamanangsuran->Angsuran_Ke->CurrentValue) ?>">
<?php } ?>
<?php if ($t04_pinjamanangsuran->RowType == EW_ROWTYPE_VIEW) { // View record ?>
...
<input type="text" data-table="t04_pinjamanangsuran" data-field="x_Angsuran_Tanggal" data-format="7" name="x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Angsuran_Tanggal" id="x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Angsuran_Tanggal" placeholder="<?php echo ew_HtmlEncode($t04_pinjamanangsuran->Angsuran_Tanggal->getPlaceHolder()) ?>" value="<?php echo $t04_pinjamanangsuran->Angsuran_Tanggal->EditValue ?>"<?php echo $t04_pinjamanangsuran->Angsuran_Tanggal->EditAttributes() ?>>
</span>
...
<p class="form-control-static"><?php echo $t04_pinjamanangsuran->Angsuran_Tanggal->EditValue ?></p></span>
</span>
<input type="hidden" data-table="t04_pinjamanangsuran" data-field="x_Angsuran_Tanggal" name="x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Angsuran_Tanggal" id="x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Angsuran_Tanggal" value="<?php echo ew_HtmlEncode($t04_pinjamanangsuran->Angsuran_Tanggal->CurrentValue) ?>">
<?php } ?>
<?php if ($t04_pinjamanangsuran->RowType == EW_ROWTYPE_VIEW) { // View record ?>
...
<p class="form-control-static"><?php echo $t04_pinjamanangsuran->Angsuran_Pokok->EditValue ?></p></span>
</span>
<input type="hidden" data-table="t04_pinjamanangsuran" data-field="x_Angsuran_Pokok" name="x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Angsuran_Pokok" id="x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Angsuran_Pokok" value="<?php echo ew_HtmlEncode($t04_pinjamanangsuran->Angsuran_Pokok->CurrentValue) ?>">
<?php } ?>
<?php if ($t04_pinjamanangsuran->RowType == EW_ROWTYPE_VIEW) { // View record ?>
...
<p class="form-control-static"><?php echo $t04_pinjamanangsuran->Angsuran_Bunga->EditValue ?></p></span>
</span>
<input type="hidden" data-table="t04_pinjamanangsuran" data-field="x_Angsuran_Bunga" name="x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Angsuran_Bunga" id="x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Angsuran_Bunga" value="<?php echo ew_HtmlEncode($t04_pinjamanangsuran->Angsuran_Bunga->CurrentValue) ?>">
<?php } ?>
<?php if ($t04_pinjamanangsuran->RowType == EW_ROWTYPE_VIEW) { // View record ?>
...
<p class="form-control-static"><?php echo $t04_pinjamanangsuran->Angsuran_Total->EditValue ?></p></span>
</span>
<input type="hidden" data-table="t04_pinjamanangsuran" data-field="x_Angsuran_Total" name="x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Angsuran_Total" id="x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Angsuran_Total" value="<?php echo ew_HtmlEncode($t04_pinjamanangsuran->Angsuran_Total->CurrentValue) ?>">
<?php } ?>
<?php if ($t04_pinjamanangsuran->RowType == EW_ROWTYPE_VIEW) { // View record ?>
...
<p class="form-control-static"><?php echo $t04_pinjamanangsuran->Sisa_Hutang->EditValue ?></p></span>
</span>
<input type="hidden" data-table="t04_pinjamanangsuran" data-field="x_Sisa_Hutang" name="x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Sisa_Hutang" id="x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Sisa_Hutang" value="<?php echo ew_HtmlEncode($t04_pinjamanangsuran->Sisa_Hutang->CurrentValue) ?>">
<?php } ?>
<?php if ($t04_pinjamanangsuran->RowType == EW_ROWTYPE_VIEW) { // View record ?>
...
<input type="text" data-table="t04_pinjamanangsuran" data-field="x_Tanggal_Bayar" data-format="7" name="x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Tanggal_Bayar" id="x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Tanggal_Bayar" size="10" placeholder="<?php echo ew_HtmlEncode($t04_pinjamanangsuran->Tanggal_Bayar->getPlaceHolder()) ?>" value="<?php echo $t04_pinjamanangsuran->Tanggal_Bayar->EditValue ?>"<?php echo $t04_pinjamanangsuran->Tanggal_Bayar->EditAttributes() ?>>
<?php if (!$t04_pinjamanangsuran->Tanggal_Bayar->ReadOnly && !$t04_pinjamanangsuran->Tanggal_Bayar->Disabled && !isset($t04_pinjamanangsuran->Tanggal_Bayar->EditAttrs["readonly"]) && !isset($t04_pinjamanangsuran->Tanggal_Bayar->EditAttrs["disabled"])) { ?>
<script type="text/javascript">
ew_CreateCalendar("ft04_pinjamanangsurangrid", "x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Tanggal_Bayar", 7);
</script>
<?php } ?>
</span>
...
<input type="text" data-table="t04_pinjamanangsuran" data-field="x_Total_Denda" name="x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Total_Denda" id="x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Total_Denda" size="7" placeholder="<?php echo ew_HtmlEncode($t04_pinjamanangsuran->Total_Denda->getPlaceHolder()) ?>" value="<?php echo $t04_pinjamanangsuran->Total_Denda->EditValue ?>"<?php echo $t04_pinjamanangsuran->Total_Denda->EditAttributes() ?>>
</span>
...
<input type="text" data-table="t04_pinjamanangsuran" data-field="x_Bayar_Titipan" name="x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Bayar_Titipan" id="x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Bayar_Titipan" size="10" placeholder="<?php echo ew_HtmlEncode($t04_pinjamanangsuran->Bayar_Titipan->getPlaceHolder()) ?>" value="<?php echo $t04_pinjamanangsuran->Bayar_Titipan->EditValue ?>"<?php echo $t04_pinjamanangsuran->Bayar_Titipan->EditAttributes() ?>>
</span>
...
<input type="text" data-table="t04_pinjamanangsuran" data-field="x_Bayar_Non_Titipan" name="x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Bayar_Non_Titipan" id="x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Bayar_Non_Titipan" size="10" placeholder="<?php echo ew_HtmlEncode($t04_pinjamanangsuran->Bayar_Non_Titipan->getPlaceHolder()) ?>" value="<?php echo $t04_pinjamanangsuran->Bayar_Non_Titipan->EditValue ?>"<?php echo $t04_pinjamanangsuran->Bayar_Non_Titipan->EditAttributes() ?>>
</span>
...
<input type="text" data-table="t04_pinjamanangsuran" data-field="x_Bayar_Total" name="x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Bayar_Total" id="x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Bayar_Total" size="10" placeholder="<?php echo ew_HtmlEncode($t04_pinjamanangsuran->Bayar_Total->getPlaceHolder()) ?>" value="<?php echo $t04_pinjamanangsuran->Bayar_Total->EditValue ?>"<?php echo $t04_pinjamanangsuran->Bayar_Total->EditAttributes() ?>>
</span>
...
<?php if ($t04_pinjamanangsuran->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $t04_pinjamanangsuran_grid->RowCnt ?>_t04_pinjamanangsuran_Keterangan" class="form-group t04_pinjamanangsuran_Keterangan">
<textarea data-table="t04_pinjamanangsuran" data-field="x_Keterangan" name="x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Keterangan" id="x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Keterangan" cols="15" rows="4" placeholder="<?php echo ew_HtmlEncode($t04_pinjamanangsuran->Keterangan->getPlaceHolder()) ?>"<?php echo $t04_pinjamanangsuran->Keterangan->EditAttributes() ?>><?php echo $t04_pinjamanangsuran->Keterangan->EditValue ?></textarea>
</span>
<input type="hidden" data-table="t04_pinjamanangsuran" data-field="x_Keterangan" name="o<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Keterangan" id="o<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Keterangan" value="<?php echo ew_HtmlEncode($t04_pinjamanangsuran->Keterangan->OldValue) ?>">
<?php } ?>
<?php if ($t04_pinjamanangsuran->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $t04_pinjamanangsuran_grid->RowCnt ?>_t04_pinjamanangsuran_Keterangan" class="form-group t04_pinjamanangsuran_Keterangan">
<textarea data-table="t04_pinjamanangsuran" data-field="x_Keterangan" name="x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Keterangan" id="x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Keterangan" cols="15" rows="4" placeholder="<?php echo ew_HtmlEncode($t04_pinjamanangsuran->Keterangan->getPlaceHolder()) ?>"<?php echo $t04_pinjamanangsuran->Keterangan->EditAttributes() ?>><?php echo $t04_pinjamanangsuran->Keterangan->EditValue ?></textarea>
...
<?php } ?>
<?php if ($t04_pinjamanangsuran->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $t04_pinjamanangsuran_grid->RowCnt ?>_t04_pinjamanangsuran_Keterangan" class="t04_pinjamanangsuran_Keterangan">
<span<?php echo $t04_pinjamanangsuran->Keterangan->ViewAttributes() ?>>
<?php echo $t04_pinjamanangsuran->Keterangan->ListViewValue() ?></span>
</span>
<?php if ($t04_pinjamanangsuran->CurrentAction <> "F") { ?>
<input type="hidden" data-table="t04_pinjamanangsuran" data-field="x_Keterangan" name="x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Keterangan" id="x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Keterangan" value="<?php echo ew_HtmlEncode($t04_pinjamanangsuran->Keterangan->FormValue) ?>">
<input type="hidden" data-table="t04_pinjamanangsuran" data-field="x_Keterangan" name="o<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Keterangan" id="o<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Keterangan" value="<?php echo ew_HtmlEncode($t04_pinjamanangsuran->Keterangan->OldValue) ?>">
<?php } else { ?>
<input type="hidden" data-table="t04_pinjamanangsuran" data-field="x_Keterangan" name="ft04_pinjamanangsurangrid$x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Keterangan" id="ft04_pinjamanangsurangrid$x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Keterangan" value="<?php echo ew_HtmlEncode($t04_pinjamanangsuran->Keterangan->FormValue) ?>">
<input type="hidden" data-table="t04_pinjamanangsuran" data-field="x_Keterangan" name="ft04_pinjamanangsurangrid$o<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Keterangan" id="ft04_pinjamanangsurangrid$o<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Keterangan" value="<?php echo ew_HtmlEncode($t04_pinjamanangsuran->Keterangan->OldValue) ?>">
<?php } ?>
<?php } ?>
</td>
	<?php } ?>
...
<?php if ($t04_pinjamanangsuran->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $t04_pinjamanangsuran_grid->RowCnt ?>_t04_pinjamanangsuran_Flag_Edit" class="form-group t04_pinjamanangsuran_Flag_Edit">
<input type="text" data-table="t04_pinjamanangsuran" data-field="x_Flag_Edit" name="x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Flag_Edit" id="x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Flag_Edit" size="30" placeholder="<?php echo ew_HtmlEncode($t04_pinjamanangsuran->Flag_Edit->getPlaceHolder()) ?>" value="<?php echo $t04_pinjamanangsuran->Flag_Edit->EditValue ?>"<?php echo $t04_pinjamanangsuran->Flag_Edit->EditAttributes() ?>>
</span>
<input type="hidden" data-table="t04_pinjamanangsuran" data-field="x_Flag_Edit" name="o<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Flag_Edit" id="o<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Flag_Edit" value="<?php echo ew_HtmlEncode($t04_pinjamanangsuran->Flag_Edit->OldValue) ?>">
<?php } ?>
<?php if ($t04_pinjamanangsuran->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $t04_pinjamanangsuran_grid->RowCnt ?>_t04_pinjamanangsuran_Flag_Edit" class="form-group t04_pinjamanangsuran_Flag_Edit">
<span<?php echo $t04_pinjamanangsuran->Flag_Edit->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $t04_pinjamanangsuran->Flag_Edit->EditValue ?></p></span>
</span>
<input type="hidden" data-table="t04_pinjamanangsuran" data-field="x_Flag_Edit" name="x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Flag_Edit" id="x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Flag_Edit" value="<?php echo ew_HtmlEncode($t04_pinjamanangsuran->Flag_Edit->CurrentValue) ?>">
<?php } ?>
<?php if ($t04_pinjamanangsuran->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $t04_pinjamanangsuran_grid->RowCnt ?>_t04_pinjamanangsuran_Flag_Edit" class="t04_pinjamanangsuran_Flag_Edit">
<span<?php echo $t04_pinjamanangsuran->Flag_Edit->ViewAttributes() ?>>
<?php echo $t04_pinjamanangsuran->Flag_Edit->ListViewValue() ?></span>
</span>
<?php if ($t04_pinjamanangsuran->CurrentAction <> "F") { ?>
<input type="hidden" data-table="t04_pinjamanangsuran" data-field="x_Flag_Edit" name="x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Flag_Edit" id="x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Flag_Edit" value="<?php echo ew_HtmlEncode($t04_pinjamanangsuran->Flag_Edit->FormValue) ?>">
<input type="hidden" data-table="t04_pinjamanangsuran" data-field="x_Flag_Edit" name="o<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Flag_Edit" id="o<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Flag_Edit" value="<?php echo ew_HtmlEncode($t04_pinjamanangsuran->Flag_Edit->OldValue) ?>">
<?php } else { ?>
<input type="hidden" data-table="t04_pinjamanangsuran" data-field="x_Flag_Edit" name="ft04_pinjamanangsurangrid$x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Flag_Edit" id="ft04_pinjamanangsurangrid$x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Flag_Edit" value="<?php echo ew_HtmlEncode($t04_pinjamanangsuran->Flag_Edit->FormValue) ?>">
<input type="hidden" data-table="t04_pinjamanangsuran" data-field="x_Flag_Edit" name="ft04_pinjamanangsurangrid$o<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Flag_Edit" id="ft04_pinjamanangsurangrid$o<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Flag_Edit" value="<?php echo ew_HtmlEncode($t04_pinjamanangsuran->Flag_Edit->OldValue) ?>">
<?php } ?>
<?php } ?>
</td>
	<?php } ?>
...
<input type="text" data-table="t04_pinjamanangsuran" data-field="x_pinjamantitipan_id" name="x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_pinjamantitipan_id" id="x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_pinjamantitipan_id" size="10" placeholder="<?php echo ew_HtmlEncode($t04_pinjamanangsuran->pinjamantitipan_id->getPlaceHolder()) ?>" value="<?php echo $t04_pinjamanangsuran->pinjamantitipan_id->EditValue ?>"<?php echo $t04_pinjamanangsuran->pinjamantitipan_id->EditAttributes() ?>>
</span>
...
<?php if ($t04_pinjamanangsuran->CurrentAction <> "F") { ?>
<span id="el$rowindex$_t04_pinjamanangsuran_Keterangan" class="form-group t04_pinjamanangsuran_Keterangan">
<textarea data-table="t04_pinjamanangsuran" data-field="x_Keterangan" name="x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Keterangan" id="x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Keterangan" cols="15" rows="4" placeholder="<?php echo ew_HtmlEncode($t04_pinjamanangsuran->Keterangan->getPlaceHolder()) ?>"<?php echo $t04_pinjamanangsuran->Keterangan->EditAttributes() ?>><?php echo $t04_pinjamanangsuran->Keterangan->EditValue ?></textarea>
</span>
<?php } else { ?>
<span id="el$rowindex$_t04_pinjamanangsuran_Keterangan" class="form-group t04_pinjamanangsuran_Keterangan">
<span<?php echo $t04_pinjamanangsuran->Keterangan->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $t04_pinjamanangsuran->Keterangan->ViewValue ?></p></span>
</span>
<input type="hidden" data-table="t04_pinjamanangsuran" data-field="x_Keterangan" name="x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Keterangan" id="x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Keterangan" value="<?php echo ew_HtmlEncode($t04_pinjamanangsuran->Keterangan->FormValue) ?>">
<?php } ?>
<input type="hidden" data-table="t04_pinjamanangsuran" data-field="x_Keterangan" name="o<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Keterangan" id="o<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Keterangan" value="<?php echo ew_HtmlEncode($t04_pinjamanangsuran->Keterangan->OldValue) ?>">
	...
	<?php } ?>
	<?php if ($t04_pinjamanangsuran->Flag_Edit->Visible) { // Flag_Edit ?>
		<td data-name="Flag_Edit">
<?php if ($t04_pinjamanangsuran->CurrentAction <> "F") { ?>
<span id="el$rowindex$_t04_pinjamanangsuran_Flag_Edit" class="form-group t04_pinjamanangsuran_Flag_Edit">
<input type="text" data-table="t04_pinjamanangsuran" data-field="x_Flag_Edit" name="x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Flag_Edit" id="x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Flag_Edit" size="30" placeholder="<?php echo ew_HtmlEncode($t04_pinjamanangsuran->Flag_Edit->getPlaceHolder()) ?>" value="<?php echo $t04_pinjamanangsuran->Flag_Edit->EditValue ?>"<?php echo $t04_pinjamanangsuran->Flag_Edit->EditAttributes() ?>>
</span>
<?php } else { ?>
<span id="el$rowindex$_t04_pinjamanangsuran_Flag_Edit" class="form-group t04_pinjamanangsuran_Flag_Edit">
<span<?php echo $t04_pinjamanangsuran->Flag_Edit->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $t04_pinjamanangsuran->Flag_Edit->ViewValue ?></p></span>
</span>
<input type="hidden" data-table="t04_pinjamanangsuran" data-field="x_Flag_Edit" name="x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Flag_Edit" id="x<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Flag_Edit" value="<?php echo ew_HtmlEncode($t04_pinjamanangsuran->Flag_Edit->FormValue) ?>">
<?php } ?>
<input type="hidden" data-table="t04_pinjamanangsuran" data-field="x_Flag_Edit" name="o<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Flag_Edit" id="o<?php echo $t04_pinjamanangsuran_grid->RowIndex ?>_Flag_Edit" value="<?php echo ew_HtmlEncode($t04_pinjamanangsuran->Flag_Edit->OldValue) ?>">
