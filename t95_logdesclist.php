...
<input type="text" data-table="t95_logdesc" data-field="x_date_issued" data-format="7" name="x<?php echo $t95_logdesc_list->RowIndex ?>_date_issued" id="x<?php echo $t95_logdesc_list->RowIndex ?>_date_issued" placeholder="<?php echo ew_HtmlEncode($t95_logdesc->date_issued->getPlaceHolder()) ?>" value="<?php echo $t95_logdesc->date_issued->EditValue ?>"<?php echo $t95_logdesc->date_issued->EditAttributes() ?>>
...
<script type="text/javascript">
ew_CreateCalendar("ft95_logdesclist", "x<?php echo $t95_logdesc_list->RowIndex ?>_date_issued", 7);
</script>
<?php } ?>
</span>
...
<input type="text" data-table="t95_logdesc" data-field="x_date_solved" data-format="7" name="x<?php echo $t95_logdesc_list->RowIndex ?>_date_solved" id="x<?php echo $t95_logdesc_list->RowIndex ?>_date_solved" placeholder="<?php echo ew_HtmlEncode($t95_logdesc->date_solved->getPlaceHolder()) ?>" value="<?php echo $t95_logdesc->date_solved->EditValue ?>"<?php echo $t95_logdesc->date_solved->EditAttributes() ?>>
...
<script type="text/javascript">
ew_CreateCalendar("ft95_logdesclist", "x<?php echo $t95_logdesc_list->RowIndex ?>_date_solved", 7);
</script>
<?php } ?>
</span>
