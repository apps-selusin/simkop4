...
?>
		<li<?php echo $t03_pinjaman_add->DetailPages->TabStyle("t04_pinjamanangsuran") ?>><a href="#tab_t04_pinjamanangsuran" data-toggle="tab"><?php echo $Language->TablePhrase("t04_pinjamanangsuran", "TblCaption") ?></a></li>
<?php
	}
?>
<?php
...
?>
		<div class="tab-pane<?php echo $t03_pinjaman_add->DetailPages->PageStyle("t04_pinjamanangsuran") ?>" id="tab_t04_pinjamanangsuran">
